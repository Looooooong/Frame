    ...
    void Update()
    {
        ...
        if (controllerlink.neoserviceStarted)
        {
            ...
            if (controllerlink.controller0Connected)
            {
                ...
                {
                    controllerlink.Controller0.Rotation.Set(sensorData[7], sensorData[8], sensorData[9],
                        sensorData[10]);
                    controllerlink.Controller0.Position.Set(sensorData[11] / 1000.0f, sensorData[12] / 1000.0f,
                        -sensorData[13] / 1000.0f);
                }
            ...
            if (controllerlink.controller1Connected)
            {
                ...
                {
                    controllerlink.Controller1.Rotation.Set(sensorData[21], sensorData[22], sensorData[23],
                        sensorData[24]);
                    controllerlink.Controller1.Position.Set(sensorData[25] / 1000.0f, sensorData[26] / 1000.0f,
                        -sensorData[27] / 1000.0f);
                }
