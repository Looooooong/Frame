...
public class PackageTool : EditorWindow
{
    ...
    static public string resVersion = "1.0.0";
    ...
    [MenuItem("AssetBundles/Package", false, 1500)]
    static void Init() {
    ...
    void DrawAssetBundlesGUI()
    {
        ...
        if (GUILayout.Button("Open PersistentData Output", GUILayout.Width(200)))
        {
            AssetBundleMenuItems.ToolsOpenPerisitentData();
        }
    ...
    public static void BuildAssetBundlesForCurrentChannelWithoutCheck()
    {
        var start = DateTime.Now;
        BuildPlayer.BuildAssetBundlesWithoutCheck(buildTarget, channelType.ToString());
