...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Collision_Binding
    {
        ...
        static StackObject* get_gameObject_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.Collision instance_of_this_method = (UnityEngine.Collision)typeof(UnityEngine.Collision).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
